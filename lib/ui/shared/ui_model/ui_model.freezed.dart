...
abstract class $UiModelStateCopyWith<T, $Res> {
  factory $UiModelStateCopyWith(
      ...
      _$UiModelStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$UiModelStateCopyWithImpl<T, $Res>
    implements $UiModelStateCopyWith<T, $Res> {
  _$UiModelStateCopyWithImpl(this._value, this._then);

  final UiModelState<T> _value;
  // ignore: unused_field
  final $Res Function(UiModelState<T>) _then;
}
...
class __$$UiModelStateIdleCopyWithImpl<T, $Res>
    extends _$UiModelStateCopyWithImpl<T, $Res>
  ...
  __$$UiModelStateIdleCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$UiModelStateIdle<T>));

  @override
  _$UiModelStateIdle<T> get _value => super._value as _$UiModelStateIdle<T>;
}
...
class __$$UiModelStateLoadingCopyWithImpl<T, $Res>
  ...
  __$$UiModelStateLoadingCopyWithImpl(_$UiModelStateLoading<T> _value,
      ...
      : super(_value, (v) => _then(v as _$UiModelStateLoading<T>));

  @override
  _$UiModelStateLoading<T> get _value =>
      super._value as _$UiModelStateLoading<T>;
}
...
class __$$UiModelStateFinishedCopyWithImpl<T, $Res>
  ...
  __$$UiModelStateFinishedCopyWithImpl(_$UiModelStateFinished<T> _value,
      ...
      : super(_value, (v) => _then(v as _$UiModelStateFinished<T>));

  @override
  _$UiModelStateFinished<T> get _value =>
      super._value as _$UiModelStateFinished<T>;
...
class __$$UiModelStateErrorCopyWithImpl<T, $Res>
  ...
  __$$UiModelStateErrorCopyWithImpl(_$UiModelStateError<T> _value,
      ...
      : super(_value, (v) => _then(v as _$UiModelStateError<T>));

  @override
  _$UiModelStateError<T> get _value => super._value as _$UiModelStateError<T>;
