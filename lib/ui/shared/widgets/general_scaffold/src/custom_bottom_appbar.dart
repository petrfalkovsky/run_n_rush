...
///
/// {@tool dartpad}
/// This example shows the [BottomAppBarChildCustom], which can be configured to have a notch using the
/// [BottomAppBarChildCustom.shape] property. This also includes an optional [FloatingActionButton], which illustrates
/// the [FloatingActionButtonLocation]s in relation to the [BottomAppBarChildCustom].
///
/// ** See code in examples/api/lib/material/bottom_app_bar/bottom_app_bar.1.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// This example shows Material 3 [BottomAppBarChildCustom] with its expected look and behaviors.
///
...
/// See also:
///
///  * [NotchedShape] which calculates the notch for a notched [BottomAppBarChildCustom].
///  * [FloatingActionButton] which the [BottomAppBarChildCustom] makes a notch for.
///  * [AppBar] for a toolbar that is shown at the top of the screen.
class BottomAppBarChildCustom extends StatefulWidget {
  ...
  /// The amount of space to surround the child inside the bounds of the [BottomAppBarChildCustom].
  ///
  ...
  /// The margin between the [FloatingActionButton] and the [BottomAppBarChildCustom]'s
  /// notch.
  ///
  ...
  /// to [elevation] and used to paint the background of the [BottomAppBarChildCustom].
  ///
  /// The default is null.
  ///
  ...
  /// The double value used to indicate the height of the [BottomAppBarChildCustom].
  ///
  ...
  @override
  State createState() => _BottomAppBarChildCustomState();
}

class _BottomAppBarChildCustomState extends State<BottomAppBarChildCustom> {
  ...
  Widget build(BuildContext context) {
    ...
    final CustomClipper<Path> clipper = notchedShape != null && hasFab
        ? _BottomAppBarClipper(
            ...
            position2MoveHorizontal: widget.positionHorizontal)
